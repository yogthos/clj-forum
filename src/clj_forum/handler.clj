(ns clj-forum.handler
  (:require [compojure.core :refer [defroutes routes wrap-routes]]
            [ring.middleware.reload :as reload]
            [clj-forum.routes.home :refer [home-routes]]
            [clj-forum.routes.services :refer [service-routes]]
            [clj-forum.middleware :as middleware]
            [clj-forum.session :as session]
...
(defn init
  ...
  (timbre/info (str
                 "\n-=[clj-forum started successfully"
...
(defn destroy
  ...
  []
  (timbre/info "clj-forum is shutting down...")
  (stop-nrepl)
